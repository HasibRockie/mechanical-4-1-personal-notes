...
\section{Lecture 9: Gearing Systems for Transformation and Transmission of Rotation} 
\hfill Date: 08/08/2023

\begin{itemize}
  \item Stepless $\rightarrow$ Only for optimum condition 
  \item Stepdrive $\rightarrow$ More rigid 
\end{itemize}
