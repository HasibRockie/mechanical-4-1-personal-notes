...
\begin{titlepage}
    ...
    \hspace*{1cm} \textbf{(a) Study and performance test of a submersible pump} \\
    \hspace*{1cm} \textbf{(b)  Dismantling and assembling of a centrifugal pump} \\
    \vspace*{3.5cm} 
    ...
    \MakeTextUppercase{Date of Performance}     :\hspace{1.5cm}\textbf{16-07-2023}\\
    \vspace*{0.5cm}
    \MakeTextUppercase{Date of Submission}      :\hspace{2cm}\textbf{18-07-2023}\\
