...
\begin{titlepage}
    ...
    \vspace*{0.5cm}
    \MakeTextUppercase{Name of the Experiment} :  \textbf{STUDY AND PERFORMANCE TEST OF A POSITIVE DISPLACEMENT PUMP.} \\
    ...
    \MakeTextUppercase{Date of Performance}     :\hspace{1.5cm}\textbf{06-08-2023}\\
    \vspace*{0.5cm}
    \MakeTextUppercase{Date of Submission}      :\hspace{2cm}\textbf{07-08-2023}\\
