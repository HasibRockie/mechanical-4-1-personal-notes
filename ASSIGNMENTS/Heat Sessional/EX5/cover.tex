...
\begin{titlepage}
    ...
    \vspace*{1cm}
    \MakeTextUppercase{Experiment No.} : \textbf{05} \\
    \vspace*{0.5cm}
    \MakeTextUppercase{Name of the Experiment} : \textbf{STUDY OF GAS ENGINE OF BUET POWER PLANT}\\
    ...
    \MakeTextUppercase{Date of Performance}     :\hspace{1.5cm}\textbf{26-08-2023}\\
    \vspace*{0.5cm}
    \MakeTextUppercase{Date of Submission}      :\hspace{2cm}\textbf{04-09-2023}\\
